...
class DependencyTests():
	...
	#	print man_relations.keys() == relations.keys()
	#	print set(man_relations.keys()) - set(relations.keys())
	#	print set(relations.keys()) - set(man_relations.keys())
	...
	def dependencies_test_all(self):
		...
		"""
		return self.spanrelations_test() and self.labels_test1() and self.labels_test2() and self.labels_annotation_test() and self.labels_test3() and self.rr_test() and self.lr_test() and self.allr_test1() and self.allr_test2()
