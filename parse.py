...
if len(sys.argv) != 6:
	raise ValueError('nr of arguments incorrect, usage:\n python parse.py dependency_file sentence_file alignment_file print_scores_to print_trees_to')
...
relations = files.relation_count(20)
files.print_dict(relations, 'relations')
files.close_all()
