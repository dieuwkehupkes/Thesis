...
%Give example alignment, that we can refer to for the definitions
...
%Maybe something about the advantages of HATs??
...
\coordinate (ts) at (7.5,0);
\node [below] at (ts) {hierarchical alignment trees};
...
\end{tikzpicture}
\caption{New situations: finding consistency between dependency parses and HATS}
\end{figure}
